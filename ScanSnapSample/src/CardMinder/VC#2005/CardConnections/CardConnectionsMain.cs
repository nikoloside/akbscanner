...
{
    static class CardConnectionsMain
    {
        ...
        static void Main(string[] args)
        {
            ...
            mutex = new Mutex(false, "CardConnections");
            ...
            if (mutex.WaitOne(0, false) == false)
            {
                ...
                string windowName = "Card Connections";                         // todo: Please update Window Title
            ...
            TempDirectory = tempPath + "ScanSnapSampleCard";

            try
            {
                if (Directory.Exists(TempDirectory) == true)
                {
                    // DeleteFolder
            ...
            // Show form
            Application.Run(new FormCardConnections());
            ...
            if (string.IsNullOrEmpty(ResultFilePath) == false)
            {
                try
                {
                    // DeleteDataFolder
                    Directory.Delete(Path.GetDirectoryName(ResultFilePath), true);
